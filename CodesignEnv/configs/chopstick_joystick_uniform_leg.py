"""Joystick training task for ChopstickBot (morphology-conditioned leg length)."""
...
from ._joystick_base_chopstickbot_uniform_leg import (
    BaseJoystick,
...
class Joystick(BaseJoystick):
  def __init__(
    ...
    # Allow training/rollout scripts to override the exact scene XML path (used for
    # morphology switching across a pool of generated models).
    xml_override = ""
    try:
