...
#   # Add Hi robot assets
#   path = consts.ROOT_PATH / "xmls"
#   mjx_env.update_assets(assets, path, "*.xml")
#   mjx_env.update_assets(assets, path / "assets")
#   return assets


class HiEnv(mjx_env.MjxEnv):
  """Base class for Hi robot environments."""
  ...
  def __init__(
    ...
    # Load XML by path so relative mesh paths resolve relative to the XML file.
